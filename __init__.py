...
def enable(api: PluginApi) -> None:
    ...
    log.info("Music Duplicate Finder v2.3.11 loaded  —  diagnostic log: %s", log_file_path())
    api.logger.info(f"Music Duplicate Finder v2.3.11 loaded — log: {log_file_path()}")
